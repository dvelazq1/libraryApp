/*
Create an array to store all the books a user adds to the library. Then create an event listener
that will trigger the addBookToLibrary function when the user clicks the submit button.
*/
let myLibrary = [];
